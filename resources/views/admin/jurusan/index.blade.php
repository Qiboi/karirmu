            ...
            <div class="col-span-12 overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500">
                    <div class="p-5 border-b bg-white flex justify-between">
                        <h2 class="text-lg font-semibold text-left text-gray-900">Master Data Jurusan</h2>                        
                        <a class="px-4 py-2 bg-blue-500 rounded-md text-md font-medium text-white" href="{{ route('jurusan.create') }}">Tambah</a>
                    </div>
